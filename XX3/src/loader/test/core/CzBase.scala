...
object CzBase {
  ...
  class FullAnnot extends CzBase {
    ...
    @TagSeq(depth=1)  val idL:List[Integer] = null             //collection of scalars
    ...
    @TagSeq(loader=classOf[Cz], depth=1)  val czA:Array[Cz] = null              //array of objects
    ...
    @TagSeq(loader=classOf[Cz], depth=3)  val cz3:Array[List[Array[Cz]]] = null //deep sequence of objects
  }
  ...
  class InferAnnot extends CzBase {
    ...
    @TagSeq(depth=1)  val czA:Array[Cz] = null                //array of objects
    ...
    @TagSeq(depth=3)  val cz3:Array[List[Array[Cz]]] = null   //deep sequence of objects    
  }
